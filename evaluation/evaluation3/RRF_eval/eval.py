...
def evaluate_retrieval(query, expected_uri, reranker = None):
    ...
    """
    if reranker == None:
        retrieved_results = query_pinecone_summary(query, rerank = False)
    else:
        retrieved_results = query_pinecone_summary(query, rerank = True, reranker = reranker)
...
if __name__ == "__main__":
    ...
    for reranker in rerankers:
        ...
        filename = f'evaluation/evaluation3/summary{reranker}__n5.txt'
