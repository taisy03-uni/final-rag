...
class MetadataRAGEvaluator:
    ...
    def llm_query_classification_search(self, scenario: str, question: str, law_type: str = "") -> Dict:
        ...
        try:
            ...
            return self.multi_query_search(queries, "chunks", 5)
            
        except Exception as e:
            print(f"Error in LLM classification search: {e}")
            # Fallback to regular search
            return self.baseline_search(f"{scenario} {question}", "chunks", 5)
    ...
    def semantic_metadata_filtering(self, query: str, metadata: LegalMetadata) -> Dict:
        ...
        initial_results = self.baseline_search(query, "chunks", 10)
    ...
    def adaptive_metadata_search(self, scenario: str, question: str, law_type: str = "") -> Dict:
        ...
        if metadata.case_complexity == "complex" or len(metadata.key_concepts) > 5:
            ...
            results1 = self.metadata_guided_search(query, metadata, "chunks", 3)
            ...
            return self.metadata_guided_search(query, metadata, "chunks", 5)
...
def create_metadata_visualizations(all_results: Dict[str, List[Dict]], metadata_info: Dict[str, Any]):
    ...
    plt.tight_layout()
    plt.savefig('evaluation/evaluation4/generative_rag_results_CHUNKS.png', 
...
if __name__ == "__main__":
    ...
    with open('evaluation/evaluation4/generative_detailed_results_chunks.json', 'w') as f:
        json.dump({
            technique: {
                'results': results,
                'summary': {
