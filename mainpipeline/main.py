...
class MetadataRAGEvaluator:
    def __init__(self):
        self.pc = Pinecone(api_key="pcsk_68eZox_USoRhu2A4jt5eEqdGL2SeewVUGwzBrYMzVuSnUQiJVitUnZcPnCTtke7Ax9N31F")
        self.index = self.pc.Index(host="https://chunks-cpullh2.svc.aped-4627-b74a.pinecone.io")
        self.client = OpenAI()
    ...
    def metadata_guided_search(self, query: str, metadata: LegalMetadata, namespace: str = "chunks", top_k: int = 5, reranker = "no_reranker") -> Dict:
...
if __name__ == "__main__":
    ...
    data = load_json('code/evaluation/evaluation4/eval3.json')
    ...
    for technique_name, technique_func in techniques.items():
        ...
        with open(f'code/evaluation/evaluation4/rerankeval/metadata_rag_detailed_results_{reranker}_k{top_k}.json', 'w') as f:
            json.dump({
                technique: {
                    'results': results,
                    'summary': {
